...
BPMNCallActivity.prototype.createCalledProcess = function(callActivityToken, currentProcess,
    ...
    var options = {
        id: callActivityToken.calledProcessId,
        processDefinition: processDefinition,
        eventHandler: handler,
        persistency: currentProcess.persistency,
        parentProcess: currentProcess,
        parentToken: callActivityToken,
        parentHistoryEntry: callActivityHistoryEntry,
        manager: currentProcess.manager
    };

    createBPMNProcess(options, function(err, calledProcess){
        if(err){
            return callback(err);
        }
