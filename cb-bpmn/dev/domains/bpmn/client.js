...
/**
 */
BPMNProcessClient.prototype.restart = function() {
    this._getImplementation().restart();
};
 ...
 * @param {Object=} data
 */
BPMNProcessClient.prototype.triggerRestartEvent = function(eventName, data) {
    this._getImplementation().triggerRestartEvent(eventName, data);
};
 ...
 * @param participants
 */
BPMNProcessClient.prototype.addParticipant = function(participants) {
    return this._getImplementation().addParticipant(participants);
};
 ...
 */
BPMNProcessClient.prototype.getHistoryEntries = function() {
    return this._getImplementation().getHistoryEntries();
};
 ...
 */
BPMNProcessClient.prototype.getHistoryEntry = function(id) {
    return this._getImplementation().getHistoryEntry(id);
};
 ...
 * @return {BPMNProcessHistory.historyEntries.entry}
 */
BPMNProcessClient.prototype.setHistoryEntry = function(id, newEntry) {
    return this._getImplementation().setHistoryEntry(id, newEntry);
};
 ...
 * @return {BPMNProcessHistory.historyEntries.entry}
 */
BPMNProcessClient.prototype.setHistoryEntryData = function(id, data) {
    return this._getImplementation().setHistoryEntryData(id, data);
};
 ...
 * @return {BPMNProcessHistory.historyEntries.entry}
 */
BPMNProcessClient.prototype.addHistoryEntryData = function(id, data) {
    return this._getImplementation().addHistoryEntryData(id, data);
};
 ...
 */
BPMNProcessClient.prototype.clearBoundaryTimerEvents = function(flowObjectName) {
    return this._getImplementation().clearBoundaryTimerEvents(flowObjectName);
};
...
/**
 * If we have the process in memory, clean it
 * @param {Function} done
 */

BPMNProcessClient.prototype.cleanProcessCache = function(done) {
    var self = this;
    var implementation = self._getImplementation();
    var processId = implementation.getProcessId();
    implementation.cleanProcessCache(processId, done);
};
 ...
 * Persist the process
 */
BPMNProcessClient.prototype.persist = function(cb) {
    return this._getImplementation().persist(cb);
}
