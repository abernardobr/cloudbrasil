 ...
 * @constructor
 */
var HistoryEntry = exports.HistoryEntry = function(name, id, type, data, begin, end) {
    this.name = name;
    this.id = id;
    this.type = type;
    this.data = data || [];
...
HistoryEntry.prototype.reset = function() {
    this.end = null;
};
...
var BPMNProcessHistory = exports.BPMNProcessHistory = function(history) {
    ...
    if (history) {
        this.historyEntries = history.historyEntries.map(function(historyEntry) {
            var entry = new HistoryEntry(historyEntry.name, historyEntry.id, historyEntry.type, historyEntry.data, historyEntry.begin, historyEntry.end);
 ...
 */
BPMNProcessHistory.prototype.addEntry = function(flowObject, data) {
    this.historyEntries.push(new HistoryEntry(flowObject.name, flowObject.bpmnId, flowObject.type, data));
};
 ...
 * Resets the history
 */
BPMNProcessHistory.prototype.reset = function() {
    var historyEntry = this.historyEntries[this.historyEntries.length - 1];
