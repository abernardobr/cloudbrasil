...
// var MongoDBPersistency = require('./mongodbone.js').Persistency;
var MongoDBPersistency = require('./cloudbrasil.js').Persistency;
...
Persistency.prototype.remove = function(query, done) {
    this.implementation.remove(query, done);
};
