...
let user = {
    ...
    securityQuestion: 'Are you',
    "activationDate" : "2013-12-12T18:59:01.851+0000",
    "address" : {

    },
    "aggregateCity" : "São Paulo",
    "aggregateIdx" : [
        {
            "type" : "country",
            "value" : "Brasil",
    ...
    "changeHistory" : [
        {
            "changeDate" : "2014-04-10T20:00:56.732+0000",
            "changes" : [
                {
                    "field" : "status",
                    "fieldDescription" : "Status",
                    "originalValue" : "Criado",
                }
            ],
            "type" : 2,
            "sent" : false
        ...
        {
            "changeDate" : "2014-06-02T18:36:42.514+0000",
            "changes" : [
                {
                    "field" : "status",
                    "fieldDescription" : "Status",
    ...
    "dob" : "1967-01-22T02:00:00.000+0000",
    "email" : "admin@admin.com",
    "emailVerToken" : "",
    "emailVerified" : true,
    "extraEmails" : [
        {
            "email" : "abernardo.br@gmail.com.tu",
            "emailVerified" : true
        },
        {
            "email" : "roco@roco.com",
    ...
    "gender" : 0,
    "idcard" : "06171667811",
    "lastVisitDate" : "2014-01-29T21:49:29.874+0000",
    "modified" : "2015-02-26T23:41:36.033+0000",
    "name" : "Admin",
    "number" : "696",
    "occupation" : "Advogado de empresa",
    "password" : "$2a$11$E.xeqA0n1M5G/aRJsIcyWOScARWwivtXx7Z0Ekdil626HG53cV3jq",
    "phone" : "(11)98851-6629",
    "registerDate" : "2013-12-12T18:59:01.850+0000",
    "role" : [
        2,
        32
    ],
    ...
    "edges" : [
        {
            "edgeType" : 21,
            "node" : "54c1ae530b4912a84b425e61",
            "ownedByModel" : true,
            "status" : 0
        },
        {
            "edgeType" : 21,
            "node" : "54c1aebc13a11df74b0c49de",
            "ownedByModel" : true,
            "status" : 0
        },
        {
            "edgeType" : 21,
            "node" : "54c98d6cffff723d4ea124d8",
            "ownedByModel" : true,
            "status" : 0
        },
        {
            "edgeType" : 22,
            "node" : "54c98de3ffff723d4ea124de",
            "ownedByModel" : true,
            "status" : 0
        },
        {
            "edgeType" : 21,
            "node" : "54c9a0c5ffff723d4ea125c8",
            "ownedByModel" : true,
            "status" : 0
        },
        {
            "edgeType" : 22,
            "node" : "54c9a442ffff723d4ea125d0",
            "ownedByModel" : true,
            "status" : 0
        },
        {
            "edgeType" : 21,
            "node" : "54d4c386a52741bb34c17b14",
            "ownedByModel" : true,
            "status" : 0
        },
        {
            "edgeType" : 21,
            "node" : "54d4c6d1a52741bb34c17b1a",
            "ownedByModel" : true,
            "status" : 0
        },
        {
            "edgeType" : 22,
            "node" : "54d4e23ba52741bb34c17b67",
            "ownedByModel" : true,
            "status" : 0
        },
        {
            "edgeType" : 22,
            "node" : "54d4e27ba52741bb34c17b6e",
            "ownedByModel" : true,
            "status" : 0
        },
        {
            "edgeType" : 21,
            "node" : "54d4fc13a52741bb34c17c4f",
            "ownedByModel" : true,
            "status" : 0
        },
        {
            "edgeType" : 22,
            "node" : "54d4fec4a52741bb34c17c63",
            "ownedByModel" : true,
            "status" : 0
        },
        {
            "edgeType" : 22,
            "node" : "54d502f3a52741bb34c17c6a",
            "ownedByModel" : true,
            "status" : 0
        },
        {
            "edgeType" : 21,
            "node" : "54da560f8428aa8704ce5c42",
            "ownedByModel" : true,
            "status" : 0
        },
        {
            "edgeType" : 21,
            "node" : "54da56f88428aa8704ce5c48",
            "ownedByModel" : true,
            "status" : 0
        },
        {
            "edgeType" : 21,
            "node" : "54da570b8428aa8704ce5c4e",
            "ownedByModel" : true,
            "status" : 0
        },
        {
            "edgeType" : 21,
            "node" : "54da57e78428aa8704ce5c54",
            "ownedByModel" : true,
            "status" : 0
        },
        {
            "edgeType" : 21,
            "node" : "54da9519a77cb4b749e4573f",
            "ownedByModel" : true,
            "status" : 0
        },
        {
            "edgeType" : 21,
            "node" : "54e5207ff1076a760757841b",
            "ownedByModel" : true,
            "status" : 0
        },
        {
            "edgeType" : 21,
            "node" : "54efaf2f3a4dcae74a42d8f5",
            "ownedByModel" : true,
            "status" : 0
        }
    ]
...
describe('User Tests', function() {
    before(function(done) {
        ...
        let initData = () => {
            let funcs = [];
            funcs.push((next) => {
                HD.users().crudmongo.DIRECT().remove({}, (err, retData) => {
            ...
            funcs.push((next) => {
                HD.config().crudmongo.DIRECT().remove({}, (err, retData) => {
                    expect(err).is.null;
                    expect(retData).is.not.undefined;
                    expect(retData).is.not.empty;
                    expect(retData.result).is.not.empty;
            ...
            funcs.push((next) => {
                HD.config().crudmongo.DIRECT().create(configData, (err, retData) => {
                    expect(err).is.null;
                    expect(retData).is.not.undefined;
                    expect(retData).is.not.empty;
            ...
            funcs.push((next) => {
                HD.users().crudmongo.DIRECT().create(user, (err, retUser) => {
                    expect(err).to.be.null;
                    expect(retUser).to.be.ok;
                    expect(retUser.username).to.be.equal('admin');
                    expect(retUser.email).to.be.equal('admin@admin.com');
                    done();
                });
            });
        ...
        Mongo.connect(() => {
            ...
            users = require('../domains/session/modules/users');
    ...
    describe('Fail Login Tests', function() {
        it('Api Username', function (done) {
           let request = {
               payload: {
                   username: 'foo',
                   password: 'bar'
           ...
           users.login(request, (retData) => {
                expect(retData).to.be.ok;
                expect(retData.auth).to.be.false;
                done();
           });
        });

        it('Api Email', function (done) {
            let request = {
                payload: {
        ...
        it('Admin Username', function (done) {
            let request = {
                payload: {
                    username: 'foo',
                    password: 'bar'
        ...
        it('Api Username with wrong password', function (done) {
            let request = {
                payload: {
                    username: 'admin',
                    password: 'bar'
        ...
        it('Api Email with wrong password', function (done) {
            let request = {
                payload: {
        ...
        it('Admin Username with wrong password', function (done) {
            let request = {
                payload: {
                    username: 'admin',
                    password: 'bar'
        ...
        it('Admin Email with wrong password', function (done) {
            let request = {
                payload: {
                    username: 'admin@admin.com',
                    password: 'bar'
    ...
    describe('Login Tests', function() {
        ...
        it('Api Username Admin User', function (done) {
            users.login(request, (retData) => {
                expect(retData).to.be.ok;
                expect(retData.auth).to.be.true;
                expect(retData.user).to.be.ok;
                expect(retData.user.username).to.be.equal('admin');
                expect(request.source).to.be.equal('api');
                done();
            });
        });
        it('isLogged', function (done) {
            users.isLogged(request, (retData) => {
                expect(retData).to.be.ok;
                expect(retData.auth).to.be.true;
                expect(retData.user).to.be.ok;
                expect(retData.user.username).to.be.equal('admin');
        ...
        it('isLogged - no credentials', function (done) {
            let newRequest = _.defaultsDeep({}, request);
            delete newRequest.auth.credentials;
            users.isLogged(newRequest, (retData) => {
                expect(retData).to.be.ok;
                expect(retData.auth).to.be.true;
                expect(retData.user).to.be.ok;
                expect(retData.user.username).to.be.equal('admin');
        ...
        it('session', function (done) {
            users.session(request, (err, retData) => {
                expect(err).to.be.null;
                expect(retData).to.be.ok;
                expect(retData.auth).to.be.true;
                expect(retData.user).to.be.ok;
        ...
        it('session - no credentials', function (done) {
            let newRequest = _.defaultsDeep({}, request);
            delete newRequest.auth.credentials;
            users.session(newRequest, (err, retData) => {
                expect(err).to.be.null;
                expect(retData).to.be.ok;
                expect(retData.auth).to.be.true;
                expect(retData.user).to.be.ok;
        ...
        it('logout', function (done) {
            users.logout(request, (retData) => {
                expect(retData).to.be.ok;
                expect(retData.response).to.be.equal('OK');
                done();
            });
        });
        it('isLogged', function (done) {
    ...
    describe("Test Roles", function() {
        ...
        it("isAdminSync", function(done){
            let user1 = { role: [roles.ADMINISTRATOR] };
            expect(users.isAdminSync(user1)).to.be.true;
            let user2 = { role: [roles.VENDOR] };
            expect(users.isAdminSync(user2)).to.be.false;
            done();
        });

        it("isSUSync", function(done){
            let user1 = { role: [roles.SU] };
            expect(users.isSUSync(user1)).to.be.true;
            let user2 = { role: [roles.VENDOR] };
            expect(users.isSUSync(user2)).to.be.false;
            done();
        });

        it("checkRoleSync", function(done){
            let user1 = { role: [roles.SU] };
            expect(users.checkRoleSync(user1, roles.SU)).to.be.true;
            let user2 = { role: [roles.VENDOR] };
            expect(users.checkRoleSync(user2, roles.SU)).to.be.false;
            done();
        });
    });
});
